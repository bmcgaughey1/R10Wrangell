...
# this overview works correctly with mapview but the image saved with
# mapshot only shows the qquad labels.
...
# code below was for testing and individual plots. It does not use mapview
